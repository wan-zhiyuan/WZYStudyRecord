        ...
        children: <Widget>[
          Stack(
            children: <Widget>[
              InkWell(
                onTap: (){
                  Provide.value<CurrentIndexProvide>(context).changeIndex(2); // 2为购物车，跳转购物车
                  Navigator.pop(context);//退出detailsPage详情页
                },
                child: Container(
              ...
              Provide<CartProvide>(
                builder: (context,child,val){
                  ...
                  return Positioned(
                    ...
                    right: 10,
                    child: Container(
                      padding: EdgeInsets.fromLTRB(6, 3, 6, 3), //中间数字，外圈是圆

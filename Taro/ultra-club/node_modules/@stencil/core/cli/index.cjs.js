  ...
  switch (t.flags = t.flags || {}, t.outputTargets = t.outputTargets || [], s) {
   ...
   case "g":
    await (async (e, t) => {
      ...
      const c = [ "tsx", ...await chooseFilesToGenerate() ], g = c.some(isTest) ? "test" : "", p = s.join(n, "components", i, a);
      await t.sys.mkdir(s.join(p, g), {
        recursive: !0
      });
      const d = await Promise.all(c.map(s => (async (e, t, s, n, r, o) => {
      ...
      })(e, t, p, a, s, c.includes("css")))).catch(e => t.logger.error(e));
      if (!d) return t.sys.exit(1);
      ...
      const u = t.rootDir;
      d.map(e => console.log("  - " + s.relative(u, e)));
    })(e, t);
    break;
